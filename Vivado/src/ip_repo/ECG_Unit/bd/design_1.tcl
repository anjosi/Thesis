...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.BestPrecision {true} CONFIG.Clock_Frequency {50} CONFIG.CoefficientSource {COE_File} CONFIG.Coefficient_File {../../../../../../../src/ip_repo/ECG_Unit/coe/diff_05_45.coe} CONFIG.Coefficient_Fractional_Bits {15} CONFIG.DATA_Has_TLAST {Packet_Framing} CONFIG.Data_Fractional_Bits {16} CONFIG.Data_Sign {Signed} CONFIG.Data_Width {32} CONFIG.M_DATA_Has_TREADY {true} CONFIG.Output_Rounding_Mode {Truncate_LSBs} CONFIG.Output_Width {32} CONFIG.Quantization {Quantize_Only} CONFIG.Sample_Frequency {0.0005}  ] $differentiator_fir_0
