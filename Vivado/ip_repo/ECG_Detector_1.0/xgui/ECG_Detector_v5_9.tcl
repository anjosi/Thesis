...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_STAT_BUFFER_WINDOW" -parent ${ECG_Detector} -widget comboBox
...
proc update_PARAM_VALUE.C_STAT_BUFFER_WINDOW { PARAM_VALUE.C_STAT_BUFFER_WINDOW } {
	# Procedure called to update C_STAT_BUFFER_WINDOW when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_STAT_BUFFER_WINDOW { PARAM_VALUE.C_STAT_BUFFER_WINDOW } {
	# Procedure called to validate C_STAT_BUFFER_WINDOW
	return true
}
...
proc update_MODELPARAM_VALUE.C_STAT_BUFFER_WINDOW { MODELPARAM_VALUE.C_STAT_BUFFER_WINDOW PARAM_VALUE.C_STAT_BUFFER_WINDOW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_STAT_BUFFER_WINDOW}] ${MODELPARAM_VALUE.C_STAT_BUFFER_WINDOW}
}
