# Runtime Tcl commands to interact with - ECG_Detector_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/ECG_Detector_v1_0_include.tcl
...
# Test: CTRL_AXI
# Create a write transaction at ctrl_axi_addr address
create_hw_axi_txn w_ctrl_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $ctrl_axi_addr -data $wdata_1
# Create a read transaction at ctrl_axi_addr address
create_hw_axi_txn r_ctrl_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $ctrl_axi_addr
# Initiate transactions
run_hw_axi r_ctrl_axi_addr
run_hw_axi w_ctrl_axi_addr
run_hw_axi r_ctrl_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_ctrl_axi_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - CTRL_AXI"
} else {
	puts "Data comparison test fail for - CTRL_AXI, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
