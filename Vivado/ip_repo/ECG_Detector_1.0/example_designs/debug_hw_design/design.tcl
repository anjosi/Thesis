...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of ECG_Detector_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ECG_Detector_0/CTRL_AXI]
	connect_bd_net [get_bd_pins ECG_Detector_0/ctrl_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/ctrl_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins ECG_Detector_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins ECG_Detector_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of ECG_Detector_0 streaming interfaces..
	connect_bd_net [get_bd_pins ECG_Detector_0/de_nsd_in_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/de_nsd_in_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ECG_Detector_0/nsy_in_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/nsy_in_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ECG_Detector_0/sqr_in_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/sqr_in_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ECG_Detector_0/diff_in_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/diff_in_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ECG_Detector_0/integ_in_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/integ_in_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ECG_Detector_0/tx_smp_01_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/tx_smp_01_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ECG_Detector_0/tx_smp_02_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ECG_Detector_0/tx_smp_02_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	connect_bd_net [get_bd_pins ECG_Detector_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Copy all address to ECG_Detector_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ECG_Detector_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ECG_Detector_0_CTRL_AXI_* ]]
	puts $fp "set ctrl_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ECG_Detector_0_S_AXI_INTR_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ECG_Detector_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ECG_Detector_v1_0_hw_${i}"
